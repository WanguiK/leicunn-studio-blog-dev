# Generated by Django 3.0.5 on 2020-06-20 06:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quote', models.CharField(help_text='* Required', max_length=180)),
                ('owner', models.CharField(blank=True, help_text='* Required', max_length=100, verbose_name='Said By')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('author', models.ForeignKey(default='Anonymous', on_delete=django.db.models.deletion.SET_DEFAULT, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content', models.TextField(help_text='Comment * Required', max_length=500, verbose_name='Comment')),
                ('name', models.CharField(help_text='Name * Required', max_length=60, verbose_name='Name')),
                ('email', models.EmailField(help_text='E-mail Address * Required', max_length=100, verbose_name='E-mail Address')),
                ('image', models.CharField(max_length=23, verbose_name='Image')),
                ('website', models.URLField(blank=True, help_text='Website (Optional)', max_length=100, verbose_name='Website')),
                ('status', models.CharField(choices=[('Show', 'Show'), ('Hide', 'Hide')], default='Hide', max_length=4)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('parent', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='replies', to='blog.Comment')),
        ...
        migrations.AddField(
            model_name='author',
            name='image',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='profilepic', to='blog.Media'),
        ),
        migrations.AddField(
            model_name='author',
