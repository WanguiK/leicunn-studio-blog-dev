    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('d', 'Draft'), ('r', 'In Review'), ('p', 'Published'), ('x', 'Rejected'), ('a', 'Archived')], default='d', help_text='* Required', max_length=1)),
                ('cover', models.ImageField(help_text='Select a cover image preferably 1280 by 720 pixels', upload_to='cover/', verbose_name='Cover Image')),
